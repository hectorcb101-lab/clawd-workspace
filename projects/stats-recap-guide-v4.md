...
![Bar chart showing firm profits with mean line](stats-graphs/bar_chart_profits.png)
...
![Visualization of deviations from mean](stats-graphs/mean_variance_visual.png)
...
![Step/threshold function plot](stats-graphs/sigmoid_step.png)
...
![Linear function visualization with two inputs](stats-graphs/linear_function.png)
...
![Venn diagram showing newspaper readership](stats-graphs/venn_newspaper.png)
...
![Bayes' theorem visualization](stats-graphs/bayes_visual.png)
...
![Normal distribution with shaded region](stats-graphs/normal_distribution.png)

![Standard normal with z-score](stats-graphs/standard_normal_z.png)
...
![Dice PMF with expected value marked](stats-graphs/dice_pmf.png)
...
![Binomial distribution for hotel overbooking](stats-graphs/binomial_hotel.png)
